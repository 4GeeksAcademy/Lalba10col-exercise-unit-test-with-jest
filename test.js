...
test("One dollar should be 154.375 Yenes", function () {
    // Importo la funcion desde app.js
    const { fromDollarToYen } = require('./app.js');
    // Uso la función como debe ser usada
    const Yenes = fromDollarToYen(5);
    // Si 1 dolar son 154.375 Yenes, entonces 5 dolares debe ser (5 * 154.375)
    const expected = 5 * 154.375;
    // Hago mi comparación (la prueba)
    expect(fromDollarToYen(5)).toBe(771.875); // 1 dolar son 154.375 yenes, entonces 5 dolares deberían ser = (5 * 154.375)
})